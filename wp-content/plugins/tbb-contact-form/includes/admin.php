...
final class TBB_Contact_Form_Admin {
	private const MENU_SLUG = 'tbb-contact-messages';
	...
	public function register_menu(): void {
		add_menu_page(
			__('Contact Messages', 'tbb-contact-form'),
			__('Contact Messages', 'tbb-contact-form'),
			'manage_options',
			self::MENU_SLUG,
			[$this, 'render_page'],
	...
	private function render_list(): void {
		...
		?>
		<div class="wrap">
			<h1><?php echo esc_html__('Contact Messages', 'tbb-contact-form'); ?></h1>
			...
			<?php else : ?>
				<table class="widefat fixed striped">
					...
					<tr>
						...
						<th><?php echo esc_html__('Subject', 'tbb-contact-form'); ?></th>
	...
	private function render_single(int $id): void {
		...
		?>
		<div class="wrap">
			<h1><?php echo esc_html__('Contact Message', 'tbb-contact-form'); ?></h1>

			<p>
				<a class="button" href="<?php echo esc_url(menu_page_url(self::MENU_SLUG, false)); ?>">
			...
			<table class="widefat striped">
				<tbody>
					...
					<tr>
						<th><?php echo esc_html__('Name', 'tbb-contact-form'); ?></th>
						<td><?php echo esc_html((string) $msg['name']); ?></td>
					</tr>
					<tr>
						<th><?php echo esc_html__('Email', 'tbb-contact-form'); ?></th>
						<td><a href="mailto:<?php echo esc_attr((string) $msg['email']); ?>"><?php echo esc_html((string) $msg['email']); ?></a></td>
					</tr>
					<tr>
						<th><?php echo esc_html__('Subject', 'tbb-contact-form'); ?></th>
						<td><?php echo esc_html((string) $msg['subject']); ?></td>
					</tr>
					<tr>
					...
					<tr>
						<th><?php echo esc_html__('Message', 'tbb-contact-form'); ?></th>
						<td style="white-space: pre-wrap;"><?php echo esc_html((string) $msg['message']); ?></td>
					</tr>
					<tr>
