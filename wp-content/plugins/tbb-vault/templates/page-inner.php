<?php
/**
 * TBB Vault — Inner content (replaces theme template-inner.php when assigned).
 */
...
<div id="primary" class="content-area primary tbb-vault tbb-vault--inner">
	<main id="main" class="site-main">
		<?php
		while (have_posts()) {
			the_post();
			$post = get_post();
			do_action('tbb_vault_before_inner', $post);
			if (!$can_view) {
			...
			do_action('tbb_vault_after_inner', get_post());
		}
		?>
	</main>
</div>
